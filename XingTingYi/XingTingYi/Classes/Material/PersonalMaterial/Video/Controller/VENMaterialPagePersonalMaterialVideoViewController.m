...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(refreshPersonalMaterialAudioPage) name:@"RefreshPersonalMaterialVideoPage" object:nil];
